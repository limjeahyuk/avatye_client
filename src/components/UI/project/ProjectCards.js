                            ...
                            >
                                ...
                                {project.summary && 
                                    <span className={classes.datebox}>
                                        ...
                                        <span className={classes.subdate}>
                                            {date2.diff(date1, "days") < 0 ? 
                                                (project.nowPrice / project.goalPrice * 100 < 100 ? "펀딩 무산" : "펀딩 성공") : (date2.diff(date1, "days") === 0 ?  "오늘 마감" : `${date2.diff(date1, "days")}일 남음`)}
                                            </span>
                                    </span>
                                }
                            </div>
                        ...
                        {project.nowPrice && 
                            <div className={classes.progressbarbox}> 
                                <div 
                                    ...
                                    style={{ width: `${project.nowPrice / project.goalPrice * 100}` > 100 ?
                                         '100%' : `${project.nowPrice / project.goalPrice * 100}%`}}
                                ></div>
                            </div>
                        }
                    </div>
